...
if __name__ == '__main__':
    ...
    for batch_size in [128]:
        for layer_size in [250]:
            ...
            # lin5 = [8, layer_size, layer_size, layer_size, layer_size, layer_size, layer_size]

            for layer_num in [lin2]:
                flags = flagreader.read_flag()  	#setting the base case
                flags.linear = layer_num
                flags.batch_size = batch_size
                # flags.learn_rate = learning_rate
                for j in range(5):
                    flags.model_name = model_name + "_bs" + str(batch_size) + "_layerSize" + str(layer_size) \
